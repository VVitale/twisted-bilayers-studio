...
if (neigh_shell == 1)
    ...
    for ih = 1 : length(hopping)
		...
		if(ir == 9 && jr(ih) == 7)
		   hopping(ih) = -type4(9,8)*s2t2(jr(ih)); 
	        elseif(ir == 7 && jr(ih) == 9)
		   hopping(ih) = -type4(8,9)*s2t1; 
	        elseif(ir == 11 && jr(ih) == 7)
		   hopping(ih) = -type4(11,8)*s2t2(jr(ih)); 
	        elseif(ir == 7 && jr(ih) == 11)
		   hopping(ih) = -type4(8,11)*s2t1;
	        elseif(ir == 10 && jr(ih) == 8)
		   hopping(ih) = type4(10,7)*s2t2(jr(ih)); 
	        elseif(ir == 8  && jr(ih) == 10)
		   hopping(ih) = type4(7,10)*s2t1;
	        end
        ...
        elseif(sym_sign(ih) > 0)
            ...
            if(abs(d4-1)<tol || abs(d4+1)<tol)
                hopping(ih) = type4(ir,jr(ih),layer);
		if(ir == 10 && jr(ih) == 7)
		   hopping(ih) = -type4(10,8)*s2t2(jr(ih)); 
	        elseif(ir == 7 && jr(ih) == 10)
		   hopping(ih) = -type4(8,10)*s2t1; 
	        elseif(ir == 9 && jr(ih) == 8)
		   hopping(ih) = type4(9,7)*s2t2(jr(ih)); 
	        elseif(ir == 8 && jr(ih) == 9)
		   hopping(ih) = type4(7,9)*s2t1; 
	        elseif(ir == 11 && jr(ih) == 8)
		   hopping(ih) = type4(11,7)*s2t2(jr(ih)); 
	        elseif(ir == 8 && jr(ih) == 11)
		   hopping(ih) = type4(7,11)*s2t1;
	        end
