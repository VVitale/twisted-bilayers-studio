function hopping = assign_hoppings_all(a1,a2,delta,loc_theta1,loc_theta2,neigh_shell,layer,sym_sign,ir,jr,type1,type2,type3,type4,type5,type6)
...
elseif(neigh_shell == 3)
    ...
    for ih = 1 : length(hopping)
        ...
        elseif(ir == 9 && jr(ih) == 8)
            if(abs(d7-1) < tol)
                hopping(ih)  = type6(9,8,layer)*c2t2(ih);
            elseif(abs(d8-1) < tol)
                hopping(ih)  = -0.5*type6(9,8,layer)*c2t2(ih) - sqrt(3)/2*type6(9,8,layer)*s2t2(ih);
	    elseif(abs(d9-1) < tol)
                hopping(ih)  = -0.5*type6(9,8,layer)*c2t2(ih) + sqrt(3)/2*type6(9,8,layer)*s2t2(ih);
            end
        elseif(ir == 9 && jr(ih) == 7)
            if(abs(d7-1) < tol)
                hopping(ih)  = -type6(9,8,layer)*s2t2(ih);
	    elseif(abs(d8-1) < tol)
                hopping(ih)  = -sqrt(3)/2*type6(9,8,layer)*c2t2(ih) + 1/2*type6(9,8,layer)*s2t2(ih);
            elseif(abs(d9-1) < tol)
                hopping(ih)  = sqrt(3)/2*type6(9,8,layer)*c2t2(ih) + 1/2*type6(9,8,layer)*s2t2(ih);
            end
        elseif(ir == 10 && jr(ih) == 7)
            if(abs(d8-1) < tol)
                hopping(ih)  = 3/4*type6(11,8,layer)*c2t2(ih) - sqrt(3)/4*type6(11,8,layer)*s2t2(ih);
	    elseif(abs(d9-1) < tol || abs(d9+1) < tol)
                hopping(ih)  = 3/4*type6(11,8,layer)*c2t2(ih) + sqrt(3)/4*type6(11,8,layer)*s2t2(ih);
            end
        elseif(ir == 10 && jr(ih) == 8)
            if(abs(d8-1) < tol)
                hopping(ih)  = sqrt(3)/4*type6(11,8,layer)*c2t2(ih) + 3/4*type6(11,8,layer)*s2t2(ih);
            elseif(abs(d9-1) < tol)
                hopping(ih)  = -sqrt(3)/4*type6(11,8,layer)*c2t2(ih) + 3/4*type6(11,8,layer)*s2t2(ih);
            end
        elseif(ir == 11 && jr(ih) == 7)
	    if(abs(d7-1) < tol)
		hopping(ih) = -type6(11,8,layer)*s2t2(ih);
            elseif(abs(d8-1) < tol)
                hopping(ih)  = sqrt(3)/4*type6(11,8,layer)*c2t2(ih) - 1/4*type6(11,8,layer)*s2t2(ih);
            elseif(abs(d9-1) < tol || abs(d9+1) < tol)
                hopping(ih)  = -sqrt(3)/4*type6(11,8,layer)*c2t2(ih) - 1/4*type6(11,8,layer)*s2t2(ih);
            end
        elseif(ir == 11 && jr(ih) == 8)
            if(abs(d7-1) < tol)
                hopping(ih)  = type6(11,8,layer)*c2t2(ih);
            elseif(abs(d8-1) < tol)
                hopping(ih)  = 1/4*type6(11,8,layer)*c2t2(ih) + sqrt(3)/4*type6(11,8,layer)*s2t2(ih);
	    elseif(abs(d9-1) < tol)
                hopping(ih)  = 1/4*type6(11,8,layer)*c2t2(ih) - sqrt(3)/4*type6(11,8,layer)*s2t2(ih);
            end
        else
