...
for it = 1:nmoire
    ...
    if (corr_nat < nat_max)
        ...
        % Bottom layer first
        [nat,nat1,nat2,pos,pos2,id1,id2,at_num1,at_num2]=generate_structure(a/3,u,c,z,3/4*I,Rtheta,ncell,alat1/3,ialatL,tol,pos,pos2,id1,id2,id11,id12,id13,id21,id22,id23,at_num1,at_num2,at_num11,at_num12,at_num13,at_num21,at_num22,at_num23,layer1,layer2,phase);
...
function y = num_atoms(m,n,c)
    ...
    elseif (c==3)
        y = 27*(n^2 - n*m + m^2) + 27/2*(1 - n + 2*m) + 32*(n^2 -n*m + m^2) + 32/2*(1 -n + 2*m) + 1/2*5*(1-n+2*m) + 1;
    end
