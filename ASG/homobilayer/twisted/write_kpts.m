function y = print_kpts(npts,ralat,recL,th_string,str_m,str_n,path,bilayer)
        ...
        elseif(bilayer==2)
           Gamma = 0*ralat2(:,1) + 0*ralat2(:,2);       
           K1 = 2/3*ralat2(:,1) - 1/3*ralat2(:,2);
           K2 = -2/3*ralat2(:,1) + 1/3*ralat2(:,2);
           M = 0.5*ralat2(:,1);
        end
